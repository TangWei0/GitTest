...
func Area1(width : Double , height : Double , long : Double) -> Double {
...
func Name (_ welcome : String , name : String = "toui" , s : Int = 9) {
...
//10.两个返回值
func st (_ weight : Double , height : Double) -> (Double , Double) {
    let s = weight * height
...
func sum2 (_ mathfunc : (Int , Int) -> Int , a : Int , b : Int){
    //print("\(mathfunc(a, b))")
}
sum2(add, a: 5, b: 10)

//13.函数也可以作为返回值
func squr (_ num : Int) -> Int {
    return num * num
}
func cube (_ num : Int) -> Int {
    return num * num * num
}
func mathfunc (name : String) -> (Int) -> Int {
    switch (name) {
    case "squr" :
        return squr
    default :
