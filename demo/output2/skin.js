...
// Generated 火 10月 17 02:53:27 2017
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._movemode.onclick=function (e) {
			me.player.openUrl("maindemo1.html","");
		}
		...
		this._tt_movemode_white__text.innerHTML="\u6700\u77ed\u7d4c\u8def\u63a2\u7d22\u30b5\u30a4\u30c8";
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='hotspot') {
			...
			this._hstext__text.innerHTML=me.hotspot.title+"<br\/>"+me.hotspot.description;
			...
			this._hstext.onmouseover=function (e) {
				me.elementMouseOver['hstext']=true;
			}
			this._hstext.onmouseout=function (e) {
				me.elementMouseOver['hstext']=false;
			}
			this._hstext.ontouchend=function (e) {
				me.elementMouseOver['hstext']=false;
			}
			me._hstext.ggCurrentLogicStateBackgroundColor = -1;
			this._hstext.ggUpdateConditionTimer=function () {
				...
				if (me._hstext.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
					me._hstext.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
					me._hstext__text.style[domTransition]='background-color none';
					if (me._hstext.ggCurrentLogicStateBackgroundColor == 0) {
						me._hstext__text.style.backgroundColor="rgba(255,255,255,1)";
					}
					else {
						me._hstext__text.style.backgroundColor="rgba(255,255,255,0.705882)";
					}
				}
			}
