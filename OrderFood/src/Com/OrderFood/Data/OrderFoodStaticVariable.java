...
public class OrderFoodStaticVariable {
    ...
    public static String LogPath = new File ( "" ).getAbsolutePath ()
            + "\\Log\\";
    public static String OldLogPath = LogPath
            + "Old\\";
    ...
    public static String[] account_col = {
                "account_id", "account_password" };
    public static String[] user_col = {
                "user_id", "user_name", "user_joined", "dapartment_id" };
    public static String[] department_col = {
