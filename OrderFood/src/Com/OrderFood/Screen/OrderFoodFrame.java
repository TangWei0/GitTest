...
public class OrderFoodFrame extends JFrame {
	...
	public void ofLoginFrame () throws SQLException {
		OrderFoodApp.ofLogger.ofWriteLogger ( "CONFIG", OrderFoodApp.ofWidth
		        + " " + OrderFoodApp.ofHeight );
		...
		frame.setSize ( OrderFoodApp.ofWidth, OrderFoodApp.ofHeight );
		...
		OrderFoodApp.Access.runSQL ( sSQL );
		...
		while ( OrderFoodApp.Access.resultSet.next () ) {
			...
			Account.setID ( OrderFoodApp.Access.resultSet
			        .getString ( "account_id" ) );
			Account.setPassword ( OrderFoodApp.Access.resultSet
			        .getString ( "account_password" ) );
			AccountList.add ( Account );
		}
		OrderFoodApp.Access.resultSet = null;

		OrderFoodApp.Access.CloseAccessStatement ();
