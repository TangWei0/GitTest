			...
			if (Variable.User.getNames() != null) {
				...
				if (Variable.Account.getPassword().equals(Variable.Password)) {
					...
					if (Variable.Status.getLoginStatus()) {
						if (Variable.Status.getConnectTime() + Enum.TimerOut < System
								.currentTimeMillis()) {
		...
		public void actionPerformed(ActionEvent e) {
			if (Variable.NetworkStateResult
				...
				if (e.getSource() == Login_btn) {
					...
					Variable.Password = String.valueOf(Password_fld
							.getPassword());
